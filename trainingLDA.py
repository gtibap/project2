# Training Linear Discriminant function
...
outFilename  = 'data/LDAParameters.mat'
...
##
# one covariance matrix it is a sum of covariance matrices of each class weigthed by the propability of each classes

covTotal = pslo*covSlo + pfre*covFre + pspa*covSpa + pger*covGer + ppol*covPol 
#print "covTotal: ", covTotal

sio.savemat(outFilename, {'meanSlo':meanSlo, 'meanFre':meanFre, 'meanSpa':meanSpa, 'meanGer':meanGer, 'meanPol':meanPol, 'covTotal':covTotal, "pslo":pslo, 'pfre':pfre, 'pspa':pspa, 'pger':pger, 'ppol':ppol})
